...
options = options + r'      -n, --chunk_num  <number>               Chunk number, default = 10,740 (for testing only)' + '\n'
...
degree_table = get_degrees(chunk_num, chunk_num*5, f_seed)
cup = Glass(chunk_num)
